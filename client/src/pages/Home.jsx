...
import { BsMic, BsRobot, BsClock, BsBarChart, BsFileEarmark, BsFileEarmarkText } from 'react-icons/bs'
import { IoSparklesSharp } from "react-icons/io5";
import { useSelector } from 'react-redux';
import AuthModel from '../components/AuthModel';
import { useNavigate } from 'react-router-dom';
import evalImg from '../assets/aiAns.png'
import techImg from '../assets/tech.png'
import confidanceImg from "../assets/confi.png"
      ...
      <div className='flex-1 px-6 py-20'>
        ...
        <div className='flex justify-center mb-6'>
          <div className='bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
            {<IoSparklesSharp className='bg-green-50 text-green-600' size={18}/>}
        ...
        {/* Inteview Steps Cards Start Here  */}
        ...
        <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
          {
            [
              ...
              <motion.div
               ...
               key={index} className={`
              relative bg-white rounded-3xl border-2 border-green-100 hover:border-greeen-500 p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl transition-all duration-300
              ${index === 0 ? "rotate-[-4deg]" : ""}
        ...
        {/* Interview Step Card End Here */}


          {/* Advaced AI Capabilities Start Here  */}
        <div className='mb-32'>
          <motion.h2
          ...
          <div className='grid md:grid-cols-2 gap-10'>
            {
              [
                ...
                },
                {
                  ...
                  desc : "Track porgress with performance graphs and topic analysis."
                }
              ].map((item,index)=>(
                <motion.div
        ...
        {/* Advaced AI Capabilities End Here  */}
          ...
          <div className='grid md:grid-cols-2 gap-10'>
            {
              [
                ...
                },
                {
                  ...
                  desc : "Basic tone and voice anlysis insights"
                }, 
                {
                  image: creditImg,
                  title: "Credit System",
                  desc : "Unlocked premium interview Session."
                }
